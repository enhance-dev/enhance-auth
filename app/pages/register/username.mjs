...
<enhance-page-container>
  ...
  <main>
    ...
    <enhance-form action="/register/username" method="post">
      ...
      <enhance-text-input label="Username" id="username" name="username"  type="text" pattern="^[a-zA-Z0-9_\-]*$" maxlength=30 required  errors="${problems?.username?.errors}" value="${register?.username || ''}"></enhance-text-input>
